...
For the purpose of this estimation, an hourly cost of 15~€/h is assumed, as suggested in the project guidelines. 
...
\hline
Literature review and theoretical study & 160 & 15 & 2400 \\
Software development and implementation & 400 & 15 & 6000 \\
Simulation, testing and validation & 200 & 15 & 3000 \\
Documentation and thesis writing & 120 & 15 & 1800 \\
\hline
Total labour cost & 880 & -- & 13200 \\
\hline
\end{tabular}
\end{table}
...
Office energy consumption values are derived from recommendations published by the Institut Català 
de l'Energia (ICAEN), which reports an average HVAC energy use of 140~kWh/m$^2$·year for office buildings 
\cite{ICAEN}. Additional reference values for office energy use and services are consistent with studies 
by the International Energy Agency and the European Environment Agency 
\cite{IEA2022Buildings,EEA2021OfficeEnergy}.
...
\hline
Electricity and HVAC (proportional share) & 380 \\
Internet and telecommunication services & 120 \\
Office consumables and miscellaneous expenses & 100 \\
\hline
Total operational expenses & 600 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Equipment amortisation}
\renewcommand{\arraystretch}{1.15}
\small
\begin{tabular}{|l|c|c|c|}
\hline
...
\hline
Laptop & 1\,800 & 0,084 & 151,2 \\
External monitor & 300 & 0,084 & 25,2 \\
\hline
Total equipment amortisation & -- & -- & 176,4 \\
\hline
\end{tabular}
\end{table}
...
\hline
Labour costs & 13\,200 \\
Operational expenses & 600 \\
Equipment amortisation & 176 \\
\hline
\textbf{Total estimated budget} & \textbf{13\,976} \\
\hline
\end{tabular}
\end{table}