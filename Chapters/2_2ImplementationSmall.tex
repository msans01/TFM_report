The implementation of the small-signal stability analysis is divided mainly into two parts: the code development
 and the GUI implementation. Strictly speaking, only the code development is part of this project. However, the
 GUI implementation was also carried out to provide a complete and user-friendly tool for performing small-signal stability analysis
 in the context of VeraGrid development as part of eRoots Analytics' main development objectives. Since the GUI implementation gives
  added value to the code development, it is also explained in this section.
...
\begin{figure}[H]
  ...
  \caption{Table result with the state matrix.}
