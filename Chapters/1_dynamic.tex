...
In power system dynamics, the network and algebraic constraints (Kirchhoff's current law, maximum current allowed in conductors, etc.) naturally provide algebraic equations, 
...
Where:
\begin{itemize}
  \item $P_{\text{inj}}$: (Algebraic variable) Active power from injections. If the injections are generators the power will be positive and if they are loads, it will be negative [MW].
  \item $Q_{\text{inj}}$: (Algebraic variable) Reactive power from injections. If the injections are generators the power will be positive and if they are loads, it will be negative [Mvar].
  \item $P_{\text{branch}}$: (Algebraic variable) Active power that is transported from or to the line connected to the bus [MW].
  \item $Q_{\text{branch}}$: (Algebraic variable) Reactive power that is transported from or to the line connected to the bus [Mvar].
\end{itemize}
