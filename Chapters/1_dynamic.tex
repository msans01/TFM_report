...
Where:
\begin{itemize}
  \item $P_{\text{sh}}$: (Algebraic variable) Active power injected or absorbed by the shunt [MW].
  \item $Q_{\text{sh}}$: (Algebraic variable) Reactive power injected or absorbed by the shunt [Mvar].
...
\begin{itemize}
  ...
  \item $P_\text{g}$: (Algebraic variable) Active electrical power delivered by the generator [MW].
  \item $Q_\text{g}$: (Algebraic variable) Reactive electrical power delivered by the generator [Mvar].
  ...
  \item $K_\text{p}$: (Constant parameter) Proportional gain of the speed governor control [-].
  \item $K_\text{i}$: (Constant parameter) Integral gain of the speed governor control [-].
\end{itemize}
\end{itemize}
...
Where:
\begin{itemize}
  \item $P_{\text{f}}$: (Algebraic variable) Active power at the beginning of the line (at the bus defined as beginning) [MW].
  \item $Q_{\text{f}}$: (Algebraic variable)Reactive power at the beginning of the line (at the bus defined as beginning) [Mvar].
  \item $P_{\text{t}}$: (Algebraic variable) Active power at the end of the line (at the bus defined as end) [MW].
  \item $Q_{\text{t}}$: (Algebraic variable)Reactive power at the end of the line (at the bus defined as end) [Mvar].
