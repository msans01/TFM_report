...
\textit{Advanced Network Dynamics and Equilibrium Simulator} (ANDES) \cite{andes}. The comparison is carried out on the classical Kundur two-area test system \cite{StabilityAndControlKundur}, 
...
For these reasons, ANDES is widely recognized as a reliable benchmark for many types of simulations such as small-signal stability studies and has been 
...
VeraGrid imports ANDES models directly from standardized \texttt{.json} files, allowing the smooth translation of system data, dynamic models, 
...
damping ratios, and oscillation frequencies computed by ANDES, confirming the equivalence of its linearization procedures and numerical solvers. 
...
The Kundur two-area system is a standard benchmark network widely used for small-signal and transient stability studies.
 It was introduced in the P. Kundur power system stability literature  as a compact, yet representative, test case that exposes 
 inter-area oscillatory modes and control interactions without excessive model complexity \cite{StabilityAndControlKundur}.
...
\begin{itemize}
    \item There are two areas connected by a pair of parallel lines. In each area, two synchronous generators are placed so that each area can swing against 
...
\hline
$\delta_1$ & \cellcolor{g2}0,123 & \cellcolor{g2}0,123 & \cellcolor{g1}0,102 & \cellcolor{g1}0,102 & \cellcolor{g3}0,174 & \cellcolor{g3}0,174 & \cellcolor{g3}0,197 & 0,006 \\

$\omega_1$ & \cellcolor{g2}0,123 & \cellcolor{g2}0,123 & \cellcolor{g1}0,102 & \cellcolor{g1}0,102 & \cellcolor{g3}0,174 & \cellcolor{g3}0,174 & 0,000 & \cellcolor{g3}0,197 \\

$\delta_2$ & \cellcolor{g3}0,151 & \cellcolor{g3}0,151 & \cellcolor{g2}0,122 & \cellcolor{g2}0,122 & \cellcolor{g2}0,117 & \cellcolor{g2}0,117 & \cellcolor{g4}0,214 & 0,006 \\

$\omega_2$ & \cellcolor{g3}0,151 & \cellcolor{g3}0,151 & \cellcolor{g2}0,122 & \cellcolor{g2}0,122 & \cellcolor{g2}0,117 & \cellcolor{g2}0,117 & 0,000 & \cellcolor{g4}0,214 \\

$\delta_3$ & \cellcolor{g2}0,103 & \cellcolor{g2}0,103 & \cellcolor{g3}0,157 & \cellcolor{g3}0,157 & \cellcolor{g2}0,102 & \cellcolor{g2}0,102 & \cellcolor{g4}0,283 & 0,006 \\

$\omega_3$ & \cellcolor{g2}0,103 & \cellcolor{g2}0,103 & \cellcolor{g3}0,156 & \cellcolor{g3}0,156 & \cellcolor{g2}0,102 & \cellcolor{g2}0,102 & 0,000 & \cellcolor{g4}0,272 \\

$\delta_4$ & \cellcolor{g2}0,123 & \cellcolor{g2}0,123 & \cellcolor{g2}0,119 & \cellcolor{g2}0,119 & \cellcolor{g2}0,108 & \cellcolor{g2}0,108 & \cellcolor{g4}0,306 & 0,006 \\

$\omega_4$ & \cellcolor{g2}0,123 & \cellcolor{g2}0,123 & \cellcolor{g2}0,119 & \cellcolor{g2}0,119 & \cellcolor{g2}0,107 & \cellcolor{g2}0,107 & 0,000 & \cellcolor{g4}0,293 \\
\hline
\end{tabular}
\end{table}
...
In this case, two pairs of complex conjugate eigenvalues located at -0,3938 $\pm$ j7,2377 and -0,3958 $\pm$ j7,1061 correspond to frequencies
 of 1,1519 and 1,1310~Hz respectively with dam-\\ping ratios near 5,5\%. These modes involve mainly the rotor angles and 
