...
The main class responsible for the EMT simulation is the Driver class, which contains the simu-\\lation function itself. 
...
Due to the large variety of models for some devices while others are standardized, a combined full numeric (traditional EMTP) and
